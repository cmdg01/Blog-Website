  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="prose lg:prose-xl mb-12">
        ...
        <p>
          Our mission is twofold: to empower individuals and communities to grow their own food sustainably and responsibly, 
          and to provide valuable resources, actionable tips, and motivational content to help individuals break through limitations 
          and achieve their dreams.
        </p>
        <p>
          We believe in the importance of local food systems and their positive impact on our environment and health. 
          Additionally, we are dedicated to empowering individuals to reach their full potential, fostering resilience, 
          and inspiring positive change in all aspects of life, including personal growth, career development, and entrepreneurship.
        </p>
